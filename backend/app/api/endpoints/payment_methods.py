...
from app.models.payment_method import PaymentMethod, DEFAULT_PAYMENT_TYPES
...
def get_payment_method_types():
    """Get predefined payment method types (key -> Japanese label)"""
...
def get_payment_methods(
    ...
    methods = (
        db.query(PaymentMethod).filter(PaymentMethod.user_id == current_user.id).all()
    )
    return methods
